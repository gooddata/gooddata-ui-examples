...
/* THIS FILE WAS AUTO-GENERATED USING CATALOG EXPORTER; YOU SHOULD NOT EDIT THIS FILE; GENERATE TIME: 2021-10-12T13:20:26.478Z; */
...
/**
 * Metric Title: Avg Campaign Spend by Qtr (Historic)
 * Metric ID: adzsM5NQhd5I
 * Metric Type: MAQL Metric
 */

export const AvgCampaignSpendByQtrHistoric = newMeasure(idRef("adzsM5NQhd5I", "measure"));
/**
...
/**
 * Metric Title: Campaign Spend by Qtr/Year
 * Metric ID: abRtFtOWiaKZ
 * Metric Type: MAQL Metric
 */

export const CampaignSpendByQtrYear = newMeasure(idRef("abRtFtOWiaKZ", "measure"));
/**
...
/**
 * Metric Title: Revenue per Dollar Spent (w/o date filter)
 * Metric ID: ac8twGQmcgXD
 * Metric Type: MAQL Metric
 */

export const RevenuePerDollarSpentWODateFilter = newMeasure(idRef("ac8twGQmcgXD", "measure"));
/**
...
/**
 * Metric Title: Total Campaign Budget This Year
 * Metric ID: ad9sQptaenY8
 * Metric Type: MAQL Metric
 */

export const TotalCampaignBudgetThisYear = newMeasure(idRef("ad9sQptaenY8", "measure"));
/**
 * Metric Title: Total Campaign Spend by Qtr/Year (Historic)
 * Metric ID: aaFtopJQdChY
 * Metric Type: MAQL Metric
 */

export const TotalCampaignSpendByQtrYearHistoric = newMeasure(idRef("aaFtopJQdChY", "measure"));
/**
 * Metric Title: Total Campaign Spend This Year
 * Metric ID: adAsQTeofR69
 * Metric Type: MAQL Metric
 */

export const TotalCampaignSpendThisYear = newMeasure(idRef("adAsQTeofR69", "measure"));
/**
...
export const Insights = {
  ...
  /**
   * Insight Title: Campaign Spend Quarterly Benchmarking (All Time)
   * Insight ID: adlsTdJ7bwD6
   */
  ,
  CampaignSpendQuarterlyBenchmarkingAllTime: "adlsTdJ7bwD6"
  /**
   * Insight Title: Revenue per Dollar Spent by Day of Week (All Time)
   * Insight ID: abbs2U1qc0YK
   */
  ,
  RevenuePerDollarSpentByDayOfWeekAllTime: "abbs2U1qc0YK"
  /**
   * Insight Title: Revenue per Dollar Spent by Quarter each Year (All Years)
   * Insight ID: abyqRvVkcmqf
   */
  ,
  RevenuePerDollarSpentByQuarterEachYearAllYears: "abyqRvVkcmqf"
};
